...
export const Fan: FC<Props> = (props) => {
...
const getStyles = stylesFactory(({height, maxSpeed, width, value}: Props) => {
  const color = value.display.color!;
  const size = width < height ? width : height;
  const spinPercent = value.display.numeric / maxSpeed;
  ...
  return {
    ...
    fanContainer: css`
      ...
      animation: ${spin} ${1 - spinPercent}s linear infinite;
